...
// Import the helper function you fixed in useAuth
...
export default function Login() {
  ...
  const handleLogin = async () => {
    ...
    setLoading(true);
    try {
      // Using the helper function ensures we hit /login/ with the trailing slash
      const response = await loginUser(email, password);
      
      if (response.status === 200) {
        Alert.alert("Success", "Welcome back!");
        // Ensure you have a dashboard.tsx file in your /app folder!
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subtitle}>Enter your HSE credentials to continue</Text>
